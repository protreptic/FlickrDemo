...
public abstract class BaseEntityListFragment_v2<T> extends Fragment implements OnRefreshListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.recyclerview_v2, container, false);
	}
